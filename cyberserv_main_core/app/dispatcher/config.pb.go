...
var file_app_dispatcher_config_proto_goTypes = []interface{}{
	(*SessionConfig)(nil), // 0: cyberservices.core.app.dispatcher.SessionConfig
	(*Config)(nil),        // 1: cyberservices.core.app.dispatcher.Config
}
var file_app_dispatcher_config_proto_depIdxs = []int32{
	0, // 0: cyberservices.core.app.dispatcher.Config.settings:type_name -> cyberservices.core.app.dispatcher.SessionConfig
