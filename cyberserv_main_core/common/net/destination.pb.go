...
type Endpoint struct {
	...
	Network Network     `protobuf:"varint,1,opt,name=network,proto3,enum=cyberservices.core.common.net.Network" json:"network,omitempty"`
...
var file_common_net_destination_proto_goTypes = []interface{}{
	(*Endpoint)(nil),   // 0: cyberservices.core.common.net.Endpoint
	(Network)(0),       // 1: cyberservices.core.common.net.Network
	(*IPOrDomain)(nil), // 2: cyberservices.core.common.net.IPOrDomain
}
var file_common_net_destination_proto_depIdxs = []int32{
	1, // 0: cyberservices.core.common.net.Endpoint.network:type_name -> cyberservices.core.common.net.Network
	2, // 1: cyberservices.core.common.net.Endpoint.address:type_name -> cyberservices.core.common.net.IPOrDomain
