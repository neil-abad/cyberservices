...
type NetworkList struct {
	...
	Network []Network `protobuf:"varint,1,rep,packed,name=network,proto3,enum=cyberservices.core.common.net.Network" json:"network,omitempty"`
}
...
var file_common_net_network_proto_goTypes = []interface{}{
	(Network)(0),        // 0: cyberservices.core.common.net.Network
	(*NetworkList)(nil), // 1: cyberservices.core.common.net.NetworkList
}
var file_common_net_network_proto_depIdxs = []int32{
	0, // 0: cyberservices.core.common.net.NetworkList.network:type_name -> cyberservices.core.common.net.Network
