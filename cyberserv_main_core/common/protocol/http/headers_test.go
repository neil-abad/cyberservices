...
func TestParseHost(t *testing.T) {
	testCases := []struct {
		...
		{
			RawHost:     "cyberservices.com:80",
			DefaultPort: 443,
			Destination: net.TCPDestination(net.DomainAddress("cyberservices.com"), 80),
		},
		{
			RawHost:     "tls.cyberservices.com",
			DefaultPort: 443,
			Destination: net.TCPDestination(net.DomainAddress("tls.cyberservices.com"), 443),
		},
		{
