...
func (c *CertificateCommand) Description() Description {
	return Description{
		...
		Usage: []string{
			"v2ctl cert [--ca] [--domain=cyberservices.com] [--expire=240h]",
...
func (c *CertificateCommand) Execute(args []string) error {
	...
	commonName := fs.String("name", "Project CS Inc", "The common name of this certificate")
	organization := fs.String("org", "Project CS Inc", "Organization of the certificate")
