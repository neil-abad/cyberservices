...
// Server is an instance of cyberservices. At any time, there must be at most one Server instance running.
...
// Instance combines all functionalities in cyberservices.
...
// New returns a new Project CS instance based on given configuration.
// The instance is not started at this point.
// To ensure Project CS instance works properly, the config must contain one Dispatcher, one InboundHandlerManager and one OutboundHandlerManager. Other features are optional.
...
// Close shutdown the Project CS instance.
...
// Start starts the Project CS instance, including all registered features. When Start returns error, the state of the instance is unknown.
// A Project CS instance can be started only once. Upon closing, the instance is not guaranteed to start again.
//
...
func (s *Instance) Start() error {
	...
	newError("Project CS ", Version(), " started").AtWarning().WriteToLog()
