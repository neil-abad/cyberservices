...
type Certificate struct {
	...
	Usage Certificate_Usage `protobuf:"varint,3,opt,name=usage,proto3,enum=cyberservices.core.transport.internet.tls.Certificate_Usage" json:"usage,omitempty"`
}
...
var file_transport_internet_tls_config_proto_goTypes = []interface{}{
	(Certificate_Usage)(0), // 0: cyberservices.core.transport.internet.tls.Certificate.Usage
	(*Certificate)(nil),    // 1: cyberservices.core.transport.internet.tls.Certificate
	(*Config)(nil),         // 2: cyberservices.core.transport.internet.tls.Config
}
var file_transport_internet_tls_config_proto_depIdxs = []int32{
	0, // 0: cyberservices.core.transport.internet.tls.Certificate.usage:type_name -> cyberservices.core.transport.internet.tls.Certificate.Usage
	1, // 1: cyberservices.core.transport.internet.tls.Config.certificate:type_name -> cyberservices.core.transport.internet.tls.Certificate
