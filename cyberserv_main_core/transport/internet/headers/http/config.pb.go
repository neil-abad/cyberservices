...
var file_transport_internet_headers_http_config_proto_goTypes = []interface{}{
	(*Header)(nil),         // 0: cyberservices.core.transport.internet.headers.http.Header
	(*Version)(nil),        // 1: cyberservices.core.transport.internet.headers.http.Version
	(*Method)(nil),         // 2: cyberservices.core.transport.internet.headers.http.Method
	(*RequestConfig)(nil),  // 3: cyberservices.core.transport.internet.headers.http.RequestConfig
	(*Status)(nil),         // 4: cyberservices.core.transport.internet.headers.http.Status
	(*ResponseConfig)(nil), // 5: cyberservices.core.transport.internet.headers.http.ResponseConfig
	(*Config)(nil),         // 6: cyberservices.core.transport.internet.headers.http.Config
}
var file_transport_internet_headers_http_config_proto_depIdxs = []int32{
	1, // 0: cyberservices.core.transport.internet.headers.http.RequestConfig.version:type_name -> cyberservices.core.transport.internet.headers.http.Version
	2, // 1: cyberservices.core.transport.internet.headers.http.RequestConfig.method:type_name -> cyberservices.core.transport.internet.headers.http.Method
	0, // 2: cyberservices.core.transport.internet.headers.http.RequestConfig.header:type_name -> cyberservices.core.transport.internet.headers.http.Header
	1, // 3: cyberservices.core.transport.internet.headers.http.ResponseConfig.version:type_name -> cyberservices.core.transport.internet.headers.http.Version
	4, // 4: cyberservices.core.transport.internet.headers.http.ResponseConfig.status:type_name -> cyberservices.core.transport.internet.headers.http.Status
	0, // 5: cyberservices.core.transport.internet.headers.http.ResponseConfig.header:type_name -> cyberservices.core.transport.internet.headers.http.Header
	3, // 6: cyberservices.core.transport.internet.headers.http.Config.request:type_name -> cyberservices.core.transport.internet.headers.http.RequestConfig
	5, // 7: cyberservices.core.transport.internet.headers.http.Config.response:type_name -> cyberservices.core.transport.internet.headers.http.ResponseConfig
